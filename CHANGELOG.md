...
- TSV rule loading now builds `CanonicalRetroReactor` instances directly from
  the parsed reactant and product query patterns, preserving the existing pickle
