...
.. note::
    ...
    4. The shipped configuration enables only four of these nine filters. The other seven are opt-in; enabling all of them is a much more aggressive curation than the SynPlanner default and will discard a substantially larger fraction of any dataset.
