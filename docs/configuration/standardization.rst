...
.. table::
    ...
    rebalance_reaction_config          Add the molecules an unbalanced reaction is missing            ``add_redox_agents: false``, ``min_confidence: 0.0``, ``drop_competing_products: false``, ``use_mapping: true``
