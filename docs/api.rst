...
- ``synplan.chem.building_blocks``: Stereo-preserving ordinary-stock preparation, full Standard InChIKey identity, and typed planner membership.
...
- ``synplan.enumeration.synthon``: Adapted Synt-On workflows for building-block classification, synthonisation, fragmentation, enumeration, stock analysis, and MCTS priority rules.
