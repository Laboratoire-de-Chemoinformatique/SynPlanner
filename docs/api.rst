...
- ``synplan.synthon``: Adapted Synt-On workflows for building-block classification, synthonisation, fragmentation, enumeration, stock analysis, and MCTS priority rules.
