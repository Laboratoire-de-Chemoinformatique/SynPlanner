...
- ``synplan.chem.reaction.routes``: Post-search route processing, including RouteCGR construction, route IO, clustering, route analysis, depiction, and quality scoring. The route quality scoring module is inspired by Westerlund et al., *J. Chem. Inf. Model.* 2026, 66, 6361 (`doi:10.1021/acs.jcim.6c01147 <https://doi.org/10.1021/acs.jcim.6c01147>`_).
- ``synplan.chem.synthon``: Adapted Synt-On workflows for building-block classification, synthonisation, fragmentation, enumeration, stock analysis, reaction-corpus coverage, and MCTS priority rules.
