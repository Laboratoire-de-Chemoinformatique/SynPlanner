...
The training dataset for ranking policy network consists of pairs of reactions and
...
The training dataset for the filtering policy is formed by the application of all
...
This makes reaction rules portable across software and data sources.