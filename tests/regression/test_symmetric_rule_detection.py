...
from synplan.chem.reaction.rules import (
    rule_query_pattern as canonical_rule_query_pattern,
)
...
def test_symmetry_helpers_are_exposed_only_from_canonical_rules_package():
    ...
    assert legacy_rules.rule_query_pattern is canonical_rule_query_pattern
    assert "rule_query_pattern" in legacy_rules.__all__
    from synplan.chem.reaction_rules import (
        rule_query_pattern as legacy_rule_query_pattern,
    )

    assert legacy_rule_query_pattern is canonical_rule_query_pattern
