...
from synplan.enumeration.synthon.priority import capped_smarts
from synplan.enumeration.synthon.reactor import (
...
def test_the_named_nucleophiles_come_from_the_capping_table():
    ...
    from synplan.enumeration.synthon.coverage import _RULE_NUCLEOPHILE_ELEMENTS
